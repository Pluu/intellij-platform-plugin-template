...
val sampleFragmentSetupTemplate
    get() = template {
        name = PluuBundle.message("pluu.fragment.and.viewmodel.new.feature.title")
        minApi = MIN_API
        description = PluuBundle.message("pluu.fragment.and.viewmodel.new.feature.description")
