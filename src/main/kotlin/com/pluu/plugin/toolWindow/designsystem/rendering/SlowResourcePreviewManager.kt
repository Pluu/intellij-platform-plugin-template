...
///////////////////////////////////////////////////////////////////////////
// Origin : https://cs.android.com/android-studio/platform/tools/adt/idea/+/mirror-goog-studio-main:android/src/com/android/tools/idea/ui/resourcemanager/rendering/SlowResourcePreviewManager.kt
///////////////////////////////////////////////////////////////////////////
...
interface SlowResourcePreviewProvider {
     ...
     */
    @Slow
    fun getSlowPreview(width: Int, height: Int, asset: DesignSystemItem): BufferedImage?
}
...
class SlowDesignResourcePreviewManager(
    ...
    override fun getIcon(
        ...
        imageIcon.image = when (image) {
            ...
            PLACEHOLDER_IMAGE -> if (shouldScale(scale)) ImageUtils.lowQualityFastScale(
                PLACEHOLDER_IMAGE,
                scale,
                scale
     ...
     */
    private fun scaleToFitIfNeeded(
