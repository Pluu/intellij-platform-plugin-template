///////////////////////////////////////////////////////////////////////////
// Origin : https://cs.android.com/android-studio/platform/tools/adt/idea/+/mirror-goog-studio-main:streaming/src/com/android/tools/idea/streaming/device/ControlMessages.kt
///////////////////////////////////////////////////////////////////////////
...
import com.pluu.plugin.toolWindow.device.controller.device.RequestDeviceStateMessage.Companion.PHYSICAL_STATE
...
internal data class KeyEventMessage(
    ...
    companion object : Deserializer {
        ...
        override fun deserialize(stream: Base128InputStream): KeyEventMessage {
            ...
            val action = AndroidKeyEventActionType.fromValue(actionValue) ?: throw StreamFormatException(
                "Unrecognized action: $actionValue"
            )
